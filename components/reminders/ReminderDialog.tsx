  ...
  useEffect(() => {
    if (reminder && isEditMode) {
      setFormData({
        ...
        due_date: reminder.due_date?.includes("T") ? reminder.due_date.split("T")[0] : reminder.due_date,
        reminder_time: reminder.reminder_time || "09:00",
        priority: reminder.priority,
        is_recurring: reminder.is_recurring,
        recurrence_pattern: reminder.recurrence_pattern,
        recurrence_interval: reminder.recurrence_interval,
        recurrence_end_date: reminder.recurrence_end_date?.includes("T") ? reminder.recurrence_end_date.split("T")[0] : reminder.recurrence_end_date,
